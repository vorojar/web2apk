...
### 强烈推荐
- [ ] **快捷方式 (Shortcuts)** - 长按图标弹出快捷入口（扫码、我的订单等），简单有效不惹人烦
...
- [ ] **快捷开关 (Quick Settings Tile)** - 下拉通知栏一键启动，适合工具类

### 可选
- [ ] **桌面组件 (Widget)** - 桌面显示网页内容摘要，适合天气/待办/新闻类
- [ ] **开机自启** - 设备重启后自动启动 APP，适合后台服务类（慎用，用户反感）

### 不推荐
- [ ] **通知栏常驻 (Foreground Service)** - 保活但耗电，除音乐/导航外易被骂
